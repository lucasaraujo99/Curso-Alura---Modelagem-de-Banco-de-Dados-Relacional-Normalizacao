-- Para os dados estarem na primeira forma normal, não podemos ter campos com mais de um valor, nem campos com valores nulos
-- Por isso, criaremos uma tabela de telefones, com um código que identifica os telefones, um codigo que identifica os clientes e os telefones
-- Também removemos os telefones da tabela clientes
